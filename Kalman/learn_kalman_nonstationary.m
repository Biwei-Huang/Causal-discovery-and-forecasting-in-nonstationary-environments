function [A, C, Q, R, initx, initV, LL] = ...
    learn_kalman_nonstationary(data, A, C, Q, R, initx, initV, model, max_iter, diagQ, diagR, ARmode, constr_fun, varargin)
...
if nargin < 10, diagQ = 0; end
if nargin < 11, diagR = 0; end
if nargin < 12, ARmode = 0; end
...
while ~converged & (num_iter <= max_iter) 
  ...
  for ex = 1:N
	...
	Estep(y, A, C, Q, R, initx, initV, model, ARmode);
    beta = beta + beta_t;
    gamma = gamma + gamma_t;
    delta = delta + delta_t;
